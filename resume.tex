...
\textbf{Coursework:} Operating Systems, Data Structures \& Algorithms, Computer Networking, Artificial Intelligence\end{rSection}
...
Mathematics & Differential Equations, Linear Algebra, Discrete Math\\
Software & Operating Systems, Compilers, Computer Organization, Networking, Embedded Programming
\end{tabular}
\end{rSection}
