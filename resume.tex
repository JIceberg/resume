...
\vspace{-0.5em}
   \begin{itemize}
      \itemsep -5pt {} 
      \item Traned and tested DNN-based RL model on the AWS DeepRacer stack for autonomous vehicle pathing with camera input
...
out of 189 total teams. Additionally was accepted for the Create-X Startup Launch with initial funding of \$35k.
\vspace{-0.5em}
