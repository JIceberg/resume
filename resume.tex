...
\vspace{-1.25em}
\item \href[pdfnewwindow=true]{https://github.com/neuraphonic/neuraphonic}{\textbf{Neuraphonic} \includegraphics[width=0.31cm,height=0.31cm,keepaspectratio]{new-tab.png}} (HackGT X) | \textit{Python, PyTorch, Scikit-Learn, Google Cloud, Twilio, MATLAB}
\vspace{-0.5em}
\begin{itemize}
   \itemsep -5pt {}
...
\end{itemize}
\vspace{-0.5em}
\item \href[pdfnewwindow=true]{https://github.com/FTCLib/FTCLib}{\textbf{FTCLib} \includegraphics[width=0.31cm,height=0.31cm,keepaspectratio]{new-tab.png}} | \textit{Java, Kotlin, OpenCV}
\vspace{-0.5em}
\begin{itemize}
   \itemsep -5pt {}
